...
@Component({
  selector: 'app-price-change-supply',
  templateUrl: './price-change-supply.component.html',
  styleUrls: ['./price-change-supply.component.css']
})
export class PriceChangeSupplyComponent implements AfterViewInit {
  ...
  ngAfterViewInit() {
    const chart = c3.generate({
      bindto: '#price-change-supply-graph',
      data: {
        columns: [
