...
@Component({
  selector: 'app-change-time-rate',
  templateUrl: './change-time-rate.component.html',
  styleUrls: ['./change-time-rate.component.css']
})
export class ChangeTimeRateComponent implements AfterViewInit {
