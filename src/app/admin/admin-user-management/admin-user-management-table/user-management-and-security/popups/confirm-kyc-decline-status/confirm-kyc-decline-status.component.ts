...
@Component({
  selector: 'app-confirm-kyc-decline-status',
  templateUrl: './confirm-kyc-decline-status.component.html',
  styleUrls: ['./confirm-kyc-decline-status.component.css']
})
export class ConfirmKycDeclineStatusComponent implements OnInit {
